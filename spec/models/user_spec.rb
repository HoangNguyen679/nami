...
RSpec.describe User, type: :model do
  describe '#valid?' do
    ...
    it "is invalid if user's first_name is blank" do
      user = create(:user)
  ...
  describe '#followings' do
    it "can list all of the user's followings" do
      ...
      Bond.create user:, friend: friend1, state: Bond::FOLLOWING
      Bond.create user:, friend: friend2, state: Bond::FOLLOWING
      Bond.create user:, friend: friend3, state: Bond::REQUESTING
